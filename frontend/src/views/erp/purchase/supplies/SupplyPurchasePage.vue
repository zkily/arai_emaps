    ...
    <el-dialog v-model="itemDialogVisible" :title="itemForm.id ? '備品を編集' : '備品を登録'" width="480px">
      <el-form :model="itemForm" label-width="96px" size="small">
        ...
        <el-form-item label="規格">
          <el-input v-model="itemForm.specification" />
        </el-form-item>
        <el-form-item label="単位">
          <el-input v-model="itemForm.unit" />
        </el-form-item>
        <el-form-item label="個数">
          <el-input-number v-model="itemForm.pack_qty" :min="1" controls-position="right" />
        </el-form-item>
        <el-form-item label="注文ロット">
          <el-input-number v-model="itemForm.order_lot" :min="1" controls-position="right" />
        </el-form-item>
        <el-form-item label="単価">
          <el-input-number v-model="itemForm.unit_price" :min="0" :precision="2" controls-position="right" />
        </el-form-item>
        <el-form-item label="終息">
          <el-switch v-model="itemForm.is_discontinued" />
        </el-form-item>
        <el-form-item label="備考">
      ...
      <template #footer>
        <el-button size="small" @click="itemDialogVisible = false">キャンセル</el-button>
...
import { Box, EditPen, OfficeBuilding, Plus, Printer, Refresh, Search, ShoppingCart, User } from '@element-plus/icons-vue'
