"""Apply migration 122_cpsat_job_lot.sql (idempotent ALTERs)."""
...
MIGRATION_FILE = BACKEND_ROOT / "database" / "migrations" / "122_cpsat_job_lot.sql"
...
async def main() -> None:
    ...
    async with AsyncSessionLocal() as db:
        ...
        await db.commit()
    print("Applied 122_cpsat_job_lot.sql")
