...
class Machine(Base):
    ...
    use_in_cpsat = Column(Boolean, nullable=False, default=True)
...
class ProductRouteStep(Base):
    ...
    yield_percent = Column(Numeric(5, 2), nullable=True)
    wait_sec_after = Column(Integer, nullable=True)
...
class ProductRouteStepMachine(Base):
    ...
    process_time_sec = Column(Numeric(10, 2), default=0)
