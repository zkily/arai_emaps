...
export const menuConfig: MenuConfigItem[] = [
  ...
  { code: 'MASTER_CUSTOMER', name: '顧客マスタ', path: '/master/customer', parentCode: 'MASTER_LIST', sortOrder: 6 },
  { code: 'MASTER_CARRIER', name: '運送便マスタ', path: '/master/carrier', parentCode: 'MASTER_LIST', sortOrder: 7 },
  { code: 'MASTER_MACHINE', name: '設備マスタ', path: '/master/machine', parentCode: 'MASTER_LIST', sortOrder: 8 },
  { code: 'MASTER_DESTINATION', name: '納入先マスタ', path: '/master/destination', parentCode: 'MASTER_LIST', sortOrder: 9 },
  { code: 'MASTER_DESTINATION_HOLIDAY', name: '納入先休日設定', path: '/master/destination/holiday', parentCode: 'MASTER_LIST', sortOrder: 10 },
