...
export const menuConfig: MenuConfigItem[] = [
  ...
  { code: 'ERP_OUTSOURCING_PLATING_ORDER', name: '外注メッキ注文', path: '/erp/purchase/outsourcing/plating-order', parentCode: 'ERP_PURCHASE_OUTSOURCING', sortOrder: 2 },
  { code: 'ERP_OUTSOURCING_PLATING_RECEIVING', name: '外注メッキ受入', path: '/erp/purchase/outsourcing/plating-receiving', parentCode: 'ERP_PURCHASE_OUTSOURCING', sortOrder: 3 },
  { code: 'ERP_OUTSOURCING_WELDING_ORDER', name: '外注溶接注文', path: '/erp/purchase/outsourcing/welding-order', parentCode: 'ERP_PURCHASE_OUTSOURCING', sortOrder: 4 },
  { code: 'ERP_OUTSOURCING_WELDING_RECEIVING', name: '外注溶接受入', path: '/erp/purchase/outsourcing/welding-receiving', parentCode: 'ERP_PURCHASE_OUTSOURCING', sortOrder: 5 },
