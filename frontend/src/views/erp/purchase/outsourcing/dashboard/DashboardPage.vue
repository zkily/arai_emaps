  ...
  <div class="dashboard-page">
    ...
    <div class="main-content">
      ...
      <div class="content-card deliveries-card">
        ...
        <div class="card-body">
          <el-table :data="upcomingDeliveries" stripe size="small" max-height="300">
      ...
      <div class="content-card suppliers-card">
        ...
        <div class="card-body">
          <el-table :data="supplierSummary" stripe size="small" max-height="300">
...
const fetchAllData = async () => {
  ...
  try {
    ...
    if (deliveriesRes.data?.success) {
      upcomingDeliveries.value = deliveriesRes.data.data || []
    }
    if (summaryRes.data?.success) {
      supplierSummary.value = summaryRes.data.data || []
    }
  } catch (error) {
