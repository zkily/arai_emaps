# -*- coding: utf-8
"""Add chamfering excel watcher hooks (mirror forming)."""
...
patch_file(
    ...
    [
        (
            """FILE_WATCH_FORMING_INDICATOR_SYNC_ENABLED=true

# LINE""",
            """FILE_WATCH_FORMING_INDICATOR_SYNC_ENABLED=true

# 面取管理指標 Excel → chamfering_production_indicator
FILE_WATCH_CHAMFERING_EXCEL_PATH=\\\\192.168.1.200\\製造部\\11各工程生産管理指標\\2.面取工程\\2026年度\\生産管理指標(2026年度-面取).xlsx
...
print("all watcher config patches done")
