    ...
    <div class="iua-toolbar iua-panel iua-fade-in iua-fade-in--d1">
      <div class="iua-toolbar__fields">
        ...
        <div class="iua-field iua-field--inspector">
          <span class="iua-field__pill"><el-icon><User /></el-icon>検査員</span>
          <el-select
...
.iua-table--inspector :deep(.el-table__header th) {
...
.iua-table--inspector :deep(.el-table__body tr:hover > td) {
