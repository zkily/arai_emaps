...
export const menuConfig: MenuConfigItem[] = [
  ...
  { code: 'MES_WELDING_INSTRUCTION', name: '溶接指示', path: '/mes/instruction/welding', parentCode: 'MES_PRODUCTION_INSTRUCTION', sortOrder: 2 },
  { code: 'MES_PLATING_INSTRUCTION', name: 'メッキ指示', path: '/mes/instruction/plating', parentCode: 'MES_PRODUCTION_INSTRUCTION', sortOrder: 3 },
