import type { PatchInspectionManagementBody } from '@/api/inspectionManagement'

export const OFFLINE_PATCH_QUEUE_KEY = 'smart_emap_mes_inspection_offline_patch_v1'
...
function writeQueue(store: OfflinePatchQueueStore): void {
  try {
    ...
    console.warn('[inspectionActual] offline queue save failed', e)
  }
}
