<template>
  <div class="outsourcing-receiving-page plating-receiving-page">
    <!-- 页面头部 -->
    ...
    <div class="kpi-row">
      ...
      <div class="kpi-card kpi-card--qty">
        ...
        <div class="kpi-card__body">
          <span class="kpi-card__value">{{ todayQuantity.toLocaleString() }}<span class="kpi-card__unit">個</span></span>
    ...
    <el-card class="filter-card glass-card">
      <el-form :inline="true" :model="filters" class="filter-form">
        ...
        <div class="filter-group filter-group--keyword">
          <span class="filter-label"><el-icon><Search /></el-icon>キーワード</span>
          <el-input
    ...
    <div class="action-bar glass-card">
      ...
      <div class="right-actions">
        ...
        <span class="summary-pill summary-pill--qty">本日 {{ todayQuantity.toLocaleString() }} 個</span>
      </div>
    </div>
    ...
    <el-card class="table-card glass-card">
      ...
      >
        ...
        <el-table-column prop="productCode" label="製品CD" width="96" />
...
.stat-chip--qty { background: rgba(14, 165, 233, 0.32); }
...
.kpi-card--today .kpi-card__icon { background: #cffafe; color: #0891b2; }
.kpi-card--qty .kpi-card__icon { background: #e0f2fe; color: #0284c7; }
.kpi-card--amount .kpi-card__icon { background: #ecfeff; color: #0d9488; }
...
.kpi-card--today { border-top: 3px solid #06b6d4; }
.kpi-card--qty { border-top: 3px solid #0ea5e9; }
.kpi-card--amount { border-top: 3px solid #14b8a6; }
