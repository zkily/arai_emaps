import type { PatchWeldingManagementBody } from '@/api/weldingManagement'

export const OFFLINE_PATCH_QUEUE_KEY = 'smart_emap_mes_welding_offline_patch_v1'
...
function writeQueue(store: OfflinePatchQueueStore): void {
  try {
    ...
    console.warn('[weldingActual] offline queue save failed', e)
  }
}
