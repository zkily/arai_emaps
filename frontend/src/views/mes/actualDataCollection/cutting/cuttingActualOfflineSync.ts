import type { PatchCuttingManagementBody } from '@/api/cuttingManagement'

export const OFFLINE_PATCH_QUEUE_KEY = 'smart_emap_mes_cutting_offline_patch_v1'
...
function writeQueue(store: OfflinePatchQueueStore): void {
  try {
    ...
    console.warn('[cuttingActual] offline queue save failed', e)
  }
}
