    ...
    children: [
      ...
      // 材料管理（外注管理と同じネスト構造）
      {
        ...
        children: [
          ...
          { path: 'inspection-master', name: 'MaterialInspectionMaster', component: () => import('@/views/erp/purchase/material/materialInspection/MaterialInspectionMaster.vue'), meta: { title: '検品マスタ', group: '材料マスタ管理', requiresAuth: true } },
