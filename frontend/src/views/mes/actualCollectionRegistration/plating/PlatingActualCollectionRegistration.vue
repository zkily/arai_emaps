  ...
  <div class="iar">
    ...
    <header class="iar-hero iar-rise">
      <div class="iar-hero__main">
        ...
        <div>
          ...
          <h1 class="iar-hero__title">メッキ実績収集登録</h1>
        </div>
      </div>
    ...
    <section class="iar-panel iar-panel--form iar-rise iar-rise--d1" :class="{ 'iar-panel--edit': isEdit }">
      ...
      <div class="iar-form">
        ...
        <div class="iar-form__below">
        <div class="iar-form__row--qty-time">
                                <div class="iar-qty iar-field--c2">
        ...
        <div class="iar-time iar-field--c3">
          <label class="iar-field__label iar-time__heading">
            <span class="iar-step iar-step--3">③</span>生産時間
          ...
          <transition name="iar-fade">
            <p v-if="timeSummary.shiftMin != null" class="iar-time__preview">
              ...
              · メンテ <b>{{ timeSummary.maintenanceMin }}</b>分
              · トラブル <b>{{ timeSummary.troubleMin }}</b>分
              · チョコ停 <b>{{ timeSummary.chocoMin }}</b>分
              · 計画停止 <b>{{ timeSummary.plannedStopMin }}</b>分
            </p>
          </transition>
        </div>
        </div>

                        <div class="iar-defects-simple iar-field--c4">
        ...
        <div class="iar-remarks iar-field--c5 iar-form__footer">
          <div class="iar-remarks__row">
            <label class="iar-field__label iar-remarks__label">
              <span class="iar-step iar-step--5">⑤</span>備考
