...
const routes: RouteRecordRaw[] = [
  ...
  // メインレイアウト配下のルート
  {
    ...
    children: [
      ...
      { path: 'erp/production/lot-forecast-attribution', name: 'LotForecastAttributionManagement', component: () => import('@/views/erp/production/planning/LotForecastAttributionManagement.vue'), meta: { title: '内示帰属管理', group: '生産管理 > 生産計画', requiresAuth: true } },
