<template>
  <div class="outsourcing-order-page plating-order-page">
    <!-- 页面头部 -->
    ...
    <div class="kpi-row">
      ...
      <div class="kpi-card kpi-card--qty">
        ...
        <div class="kpi-card__body">
          <span class="kpi-card__value">{{ formatNumber(totalQuantity) }}<span class="kpi-card__unit">個</span></span>
    ...
    <div class="action-bar glass-card">
      ...
      <div class="right-actions">
        <span class="summary-pill summary-pill--qty">{{ formatNumber(totalQuantity) }} 個</span>
    ...
    <el-card class="table-card glass-card">
      <el-table
        ...
        :header-cell-style="{ background: '#ecfeff', color: '#0f766e', fontWeight: '600' }"
      >
        ...
        <el-table-column prop="orderDate" label="注文日" width="96" align="center">
          <template #default="{ row }">
            {{ row.orderDate || '-' }}
          </template>
        </el-table-column>
        ...
        <section class="create-dialog__section create-dialog__section--table">
          ...
          <div class="create-dialog__table-wrap">
            ...
            >
              ...
              <el-table-column prop="content" label="内容" min-width="110" show-overflow-tooltip />
              <el-table-column prop="deliveryDate" label="納期" width="148" align="center">
                <template #default="{ row }">
                  <el-date-picker
...
.outsourcing-order-page {
  padding: 12px;
  background: linear-gradient(135deg, #ecfeff 0%, #f0fdfa 48%, #f8fafc 100%);
  min-height: 100vh;
}

.page-header {
  background: linear-gradient(135deg, #0ea5e9 0%, #0d9488 58%, #14b8a6 100%);
  border-radius: 16px;
  padding: 16px 22px;
  margin-bottom: 12px;
  color: white;
  box-shadow: 0 10px 28px rgba(13, 148, 136, 0.28), 0 0 0 1px rgba(255, 255, 255, 0.18) inset;
...
.page-header:hover {
  ...
  box-shadow: 0 12px 32px rgba(14, 165, 233, 0.32), 0 0 0 1px rgba(255, 255, 255, 0.22) inset;
}
...
.glass-card {
  ...
  box-shadow: 0 4px 24px rgba(13, 148, 136, 0.08), 0 0 0 1px rgba(13, 148, 136, 0.06);
  transition: box-shadow 0.25s ease, transform 0.25s ease;
}
.glass-card:hover {
  box-shadow: 0 8px 32px rgba(13, 148, 136, 0.12), 0 0 0 1px rgba(13, 148, 136, 0.08);
}
...
.stat-chip--qty { background: rgba(14, 165, 233, 0.28); }
.stat-chip--amount { background: rgba(245, 158, 11, 0.28); }
...
.kpi-card--qty .kpi-card__icon { background: #cffafe; color: #0891b2; }
...
.kpi-card--qty { border-top: 3px solid #06b6d4; }
...
.filter-group--date { border-left: 3px solid #0ea5e9; }
.filter-group--supplier { border-left: 3px solid #0d9488; }
.filter-group--product { border-left: 3px solid #6366f1; }
...
.date-picker :deep(.el-input__wrapper) {
  border-radius: 6px;
  box-shadow: 0 0 0 1px rgba(13, 148, 136, 0.22) inset;
  transition: all 0.2s;
}
