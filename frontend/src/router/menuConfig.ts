...
export const menuConfig: MenuConfigItem[] = [
  ...
  { code: 'ERP_PURCHASE_MATERIAL_HOME', name: '材料管理ホーム', path: '/erp/purchase/material', parentCode: 'ERP_PURCHASE_MATERIAL', sortOrder: 0 },
  { code: 'ERP_PURCHASE_MATERIAL_ORDER', name: '材料在庫管理', path: '/erp/purchase/material/order', parentCode: 'ERP_PURCHASE_MATERIAL', sortOrder: 1 },
  { code: 'ERP_PURCHASE_MATERIAL_RECEIVING', name: '受入履歴', path: '/erp/purchase/material/receiving-history', parentCode: 'ERP_PURCHASE_MATERIAL', sortOrder: 2 },
  { code: 'ERP_PURCHASE_MATERIAL_INSPECTION', name: '受入検品', path: '/erp/purchase/material/receiving-inspection', parentCode: 'ERP_PURCHASE_MATERIAL', sortOrder: 3 },
  { code: 'ERP_PURCHASE_MATERIAL_FORECAST', name: '内示管理', path: '/erp/purchase/material/forecast', parentCode: 'ERP_PURCHASE_MATERIAL', sortOrder: 4 },
  { code: 'ERP_PURCHASE_PART', name: '部品管理', icon: 'Box', parentCode: 'ERP_PURCHASE', sortOrder: 2 },
  { code: 'ERP_PURCHASE_PART_HOME', name: '部品管理ホーム', path: '/erp/purchase/part', parentCode: 'ERP_PURCHASE_PART', sortOrder: 0 },
  { code: 'ERP_PURCHASE_PART_ORDER', name: '部品在庫管理', path: '/erp/purchase/part/order', parentCode: 'ERP_PURCHASE_PART', sortOrder: 1 },
  ...
  { code: 'ERP_INVENTORY_LIST', name: '製品在庫照会', path: '/erp/inventory/list', parentCode: 'ERP_INVENTORY', sortOrder: 1 },
  { code: 'ERP_INVENTORY_MATERIAL_LIST', name: '材料在庫照会', path: '/erp/inventory/material-list', parentCode: 'ERP_INVENTORY', sortOrder: 2 },
  { code: 'ERP_INVENTORY_PART_LIST', name: '部品在庫照会', path: '/erp/inventory/part-list', parentCode: 'ERP_INVENTORY', sortOrder: 3 },
  { code: 'ERP_INVENTORY_STOCK_ENTRY', name: '在庫登録管理', path: '/erp/inventory/stock-entry', parentCode: 'ERP_INVENTORY', sortOrder: 4 },
  { code: 'ERP_INVENTORY_STOCK_TX_LOG', name: '在庫取引記録', path: '/erp/inventory/stock-transaction-logs', parentCode: 'ERP_INVENTORY', sortOrder: 5 },
  { code: 'ERP_INVENTORY_STOCKTAKE', name: '棚卸管理', path: '/erp/inventory/stocktake', parentCode: 'ERP_INVENTORY', sortOrder: 6 },
  ...
  { code: 'ERP_PRODUCTION_METRICS', name: '生産指標', path: '/erp/production/metrics/scrap-rate', parentCode: 'ERP_PRODUCTION', sortOrder: 5.8 },
  ...
  { code: 'APS_WELDING_PLAN_LIST', name: '溶接計画一覧', path: '/aps/welding-planning-list', icon: 'List', parentCode: 'APS_PRODUCTION_PLAN_VIEW', sortOrder: 2 },
  { code: 'APS_EQUIPMENT_UTILIZATION_MANAGEMENT', name: '設備稼働管理', icon: 'Setting', parentCode: 'APS', sortOrder: 3 },
  { code: 'APS_CAPACITY', name: '設備稼働設定', path: '/aps/capacity', parentCode: 'APS_EQUIPMENT_UTILIZATION_MANAGEMENT', sortOrder: 1 },
  ...
  { code: 'MES_PRODUCTION_MONITOR', name: '生産モニター', path: '/mes/actualDataCollection/monitor', icon: 'Monitor', parentCode: 'MES_ACTUAL_DATA_COLLECTION', sortOrder: 0 },
  ...
  { code: 'MES_ACTUAL_ANALYSIS_PRODUCTIVITY_CUTTING', name: '切断工程', path: '/mes/actualAnalysis/productivity/cutting', icon: 'Scissor', parentCode: 'MES_ACTUAL_ANALYSIS_PRODUCTIVITY', sortOrder: 1 },
  { code: 'MES_ACTUAL_ANALYSIS_PRODUCTIVITY_CHAMFERING', name: '面取工程', path: '/mes/actualAnalysis/productivity/chamfering', icon: 'Crop', parentCode: 'MES_ACTUAL_ANALYSIS_PRODUCTIVITY', sortOrder: 2 },
  { code: 'MES_ACTUAL_ANALYSIS_PRODUCTIVITY_FORMING', name: '成型工程', path: '/mes/actualAnalysis/productivity/forming', icon: 'SetUp', parentCode: 'MES_ACTUAL_ANALYSIS_PRODUCTIVITY', sortOrder: 3 },
  { code: 'MES_ACTUAL_ANALYSIS_PRODUCTIVITY_PLATING', name: 'メッキ工程', path: '/mes/actualAnalysis/productivity/plating', icon: 'Brush', parentCode: 'MES_ACTUAL_ANALYSIS_PRODUCTIVITY', sortOrder: 4 },
  { code: 'MES_ACTUAL_ANALYSIS_PRODUCTIVITY_WELDING', name: '溶接工程', path: '/mes/actualAnalysis/productivity/welding', icon: 'Connection', parentCode: 'MES_ACTUAL_ANALYSIS_PRODUCTIVITY', sortOrder: 5 },
  { code: 'MES_ACTUAL_ANALYSIS_PRODUCTIVITY_INSPECTION', name: '検査工程', path: '/mes/actualAnalysis/productivity/inspection', icon: 'DocumentChecked', parentCode: 'MES_ACTUAL_ANALYSIS_PRODUCTIVITY', sortOrder: 6 },
  { code: 'MES_ACTUAL_ANALYSIS_UTILIZATION', name: '稼働率分析', icon: 'Odometer', parentCode: 'MES_ACTUAL_ANALYSIS', sortOrder: 2 },
  { code: 'MES_ACTUAL_ANALYSIS_UTILIZATION_CUTTING', name: '切断工程', path: '/mes/actualAnalysis/utilization/cutting', icon: 'Scissor', parentCode: 'MES_ACTUAL_ANALYSIS_UTILIZATION', sortOrder: 1 },
  { code: 'MES_ACTUAL_ANALYSIS_UTILIZATION_CHAMFERING', name: '面取工程', path: '/mes/actualAnalysis/utilization/chamfering', icon: 'Crop', parentCode: 'MES_ACTUAL_ANALYSIS_UTILIZATION', sortOrder: 2 },
  { code: 'MES_ACTUAL_ANALYSIS_UTILIZATION_FORMING', name: '成型工程', path: '/mes/actualAnalysis/utilization/forming', icon: 'SetUp', parentCode: 'MES_ACTUAL_ANALYSIS_UTILIZATION', sortOrder: 3 },
  { code: 'MES_ACTUAL_ANALYSIS_UTILIZATION_PLATING', name: 'メッキ工程', path: '/mes/actualAnalysis/utilization/plating', icon: 'Brush', parentCode: 'MES_ACTUAL_ANALYSIS_UTILIZATION', sortOrder: 4 },
  { code: 'MES_ACTUAL_ANALYSIS_UTILIZATION_WELDING', name: '溶接工程', path: '/mes/actualAnalysis/utilization/welding', icon: 'Connection', parentCode: 'MES_ACTUAL_ANALYSIS_UTILIZATION', sortOrder: 5 },
  { code: 'MES_ACTUAL_ANALYSIS_UTILIZATION_INSPECTION', name: '検査工程', path: '/mes/actualAnalysis/utilization/inspection', icon: 'DocumentChecked', parentCode: 'MES_ACTUAL_ANALYSIS_UTILIZATION', sortOrder: 6 },
  { code: 'MES_ACTUAL_ANALYSIS_PROGRESS', name: '進捗分析', icon: 'DataLine', parentCode: 'MES_ACTUAL_ANALYSIS', sortOrder: 3 },
  { code: 'MES_ACTUAL_ANALYSIS_PROGRESS_CUTTING', name: '切断工程', path: '/mes/actualAnalysis/progress/cutting', icon: 'Scissor', parentCode: 'MES_ACTUAL_ANALYSIS_PROGRESS', sortOrder: 1 },
  { code: 'MES_ACTUAL_ANALYSIS_PROGRESS_CHAMFERING', name: '面取工程', path: '/mes/actualAnalysis/progress/chamfering', icon: 'Crop', parentCode: 'MES_ACTUAL_ANALYSIS_PROGRESS', sortOrder: 2 },
  { code: 'MES_ACTUAL_ANALYSIS_PROGRESS_FORMING', name: '成型工程', path: '/mes/actualAnalysis/progress/forming', icon: 'SetUp', parentCode: 'MES_ACTUAL_ANALYSIS_PROGRESS', sortOrder: 3 },
  { code: 'MES_ACTUAL_ANALYSIS_PROGRESS_PLATING', name: 'メッキ工程', path: '/mes/actualAnalysis/progress/plating', icon: 'Brush', parentCode: 'MES_ACTUAL_ANALYSIS_PROGRESS', sortOrder: 4 },
  { code: 'MES_ACTUAL_ANALYSIS_PROGRESS_WELDING', name: '溶接工程', path: '/mes/actualAnalysis/progress/welding', icon: 'Connection', parentCode: 'MES_ACTUAL_ANALYSIS_PROGRESS', sortOrder: 5 },
  { code: 'MES_ACTUAL_ANALYSIS_PROGRESS_INSPECTION', name: '検査工程', path: '/mes/actualAnalysis/progress/inspection', icon: 'DocumentChecked', parentCode: 'MES_ACTUAL_ANALYSIS_PROGRESS', sortOrder: 6 },
  { code: 'MES_ACTUAL_ANALYSIS_QUALITY', name: '品質分析', icon: 'CircleCheck', parentCode: 'MES_ACTUAL_ANALYSIS', sortOrder: 4 },
  { code: 'MES_ACTUAL_ANALYSIS_QUALITY_CUTTING', name: '切断工程', path: '/mes/actualAnalysis/quality/cutting', icon: 'Scissor', parentCode: 'MES_ACTUAL_ANALYSIS_QUALITY', sortOrder: 1 },
  { code: 'MES_ACTUAL_ANALYSIS_QUALITY_CHAMFERING', name: '面取工程', path: '/mes/actualAnalysis/quality/chamfering', icon: 'Crop', parentCode: 'MES_ACTUAL_ANALYSIS_QUALITY', sortOrder: 2 },
  { code: 'MES_ACTUAL_ANALYSIS_QUALITY_FORMING', name: '成型工程', path: '/mes/actualAnalysis/quality/forming', icon: 'SetUp', parentCode: 'MES_ACTUAL_ANALYSIS_QUALITY', sortOrder: 3 },
  { code: 'MES_ACTUAL_ANALYSIS_QUALITY_PLATING', name: 'メッキ工程', path: '/mes/actualAnalysis/quality/plating', icon: 'Brush', parentCode: 'MES_ACTUAL_ANALYSIS_QUALITY', sortOrder: 4 },
  { code: 'MES_ACTUAL_ANALYSIS_QUALITY_WELDING', name: '溶接工程', path: '/mes/actualAnalysis/quality/welding', icon: 'Connection', parentCode: 'MES_ACTUAL_ANALYSIS_QUALITY', sortOrder: 5 },
  { code: 'MES_ACTUAL_ANALYSIS_QUALITY_INSPECTION', name: '検査工程', path: '/mes/actualAnalysis/quality/inspection', icon: 'DocumentChecked', parentCode: 'MES_ACTUAL_ANALYSIS_QUALITY', sortOrder: 6 },
  { code: 'MES_ACTUAL_ANALYSIS_COST', name: 'コスト分析', icon: 'Coin', parentCode: 'MES_ACTUAL_ANALYSIS', sortOrder: 5 },
  { code: 'MES_ACTUAL_ANALYSIS_COST_CUTTING', name: '切断工程', path: '/mes/actualAnalysis/cost/cutting', icon: 'Scissor', parentCode: 'MES_ACTUAL_ANALYSIS_COST', sortOrder: 1 },
  { code: 'MES_ACTUAL_ANALYSIS_COST_CHAMFERING', name: '面取工程', path: '/mes/actualAnalysis/cost/chamfering', icon: 'Crop', parentCode: 'MES_ACTUAL_ANALYSIS_COST', sortOrder: 2 },
  { code: 'MES_ACTUAL_ANALYSIS_COST_FORMING', name: '成型工程', path: '/mes/actualAnalysis/cost/forming', icon: 'SetUp', parentCode: 'MES_ACTUAL_ANALYSIS_COST', sortOrder: 3 },
  { code: 'MES_ACTUAL_ANALYSIS_COST_PLATING', name: 'メッキ工程', path: '/mes/actualAnalysis/cost/plating', icon: 'Brush', parentCode: 'MES_ACTUAL_ANALYSIS_COST', sortOrder: 4 },
  { code: 'MES_ACTUAL_ANALYSIS_COST_WELDING', name: '溶接工程', path: '/mes/actualAnalysis/cost/welding', icon: 'Connection', parentCode: 'MES_ACTUAL_ANALYSIS_COST', sortOrder: 5 },
  { code: 'MES_ACTUAL_ANALYSIS_COST_INSPECTION', name: '検査工程', path: '/mes/actualAnalysis/cost/inspection', icon: 'DocumentChecked', parentCode: 'MES_ACTUAL_ANALYSIS_COST', sortOrder: 6 },
  ...
  { code: 'MASTER_PART', name: '部品マスタ', path: '/master/part', parentCode: 'MASTER_LIST', sortOrder: 2.75 },
  ...
  { code: 'MASTER_PRODUCT_PROCESS_ROUTE', name: '製品ルートマスタ', path: '/master/product-process-route', parentCode: 'MASTER_LIST', sortOrder: 6 },
  ...
  { code: 'OPERATION_MANUALS', name: 'マニュアル', icon: 'Document', sortOrder: 4.5 },
  {
    code: 'OP_MANUAL_FORMING',
    name: '成型工程 生産指示・実績収集',
    path: '/operation-manuals/forming-instruction',
    parentCode: 'OPERATION_MANUALS',
    sortOrder: 1,
  },
  {
    code: 'OP_MANUAL_FORMING_PLANNING',
    name: '成型工程 計画作成',
    path: '/operation-manuals/forming-planning',
    parentCode: 'OPERATION_MANUALS',
    sortOrder: 2,
  },
  {
    code: 'OP_MANUAL_WELDING',
    name: '溶接工程 生産指示・実績収集',
    path: '/operation-manuals/welding-instruction',
    parentCode: 'OPERATION_MANUALS',
    sortOrder: 3,
  },
  {
    code: 'OP_MANUAL_WELDING_PLANNING',
    name: '溶接工程 計画作成',
    path: '/operation-manuals/welding-planning',
    parentCode: 'OPERATION_MANUALS',
    sortOrder: 4,
  },
  {
    code: 'OP_MANUAL_CUTTING',
    name: '切断面取 生産指示・実績収集',
    path: '/operation-manuals/cutting-instruction',
    parentCode: 'OPERATION_MANUALS',
    sortOrder: 5,
  },
  {
    code: 'OP_MANUAL_PLAN_BASELINE',
    name: '生産計画ベースライン管理',
    path: '/operation-manuals/plan-baseline',
    parentCode: 'OPERATION_MANUALS',
    sortOrder: 6,
  },
  {
    code: 'OP_MANUAL_INSPECTION',
    name: '検査実績収集',
    path: '/operation-manuals/inspection-actual',
    parentCode: 'OPERATION_MANUALS',
    sortOrder: 7,
  },
