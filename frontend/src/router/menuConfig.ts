...
export const menuConfig: MenuConfigItem[] = [
  ...
  { code: 'MES_ACTUAL_PLATING', name: 'メッキ実績収集', path: '/mes/actualDataCollection/plating', parentCode: 'MES_ACTUAL_DATA_COLLECTION', sortOrder: 4 },
  { code: 'MES_ACTUAL_WELDING', name: '溶接実績収集', path: '/mes/actualDataCollection/welding', parentCode: 'MES_ACTUAL_DATA_COLLECTION', sortOrder: 5 },
  { code: 'MES_ACTUAL_INSPECTION', name: '検査実績収集', path: '/mes/actualDataCollection/inspection', parentCode: 'MES_ACTUAL_DATA_COLLECTION', sortOrder: 6 },
