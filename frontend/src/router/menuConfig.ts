...
export const menuConfig: MenuConfigItem[] = [
  ...
  { code: 'MES_PRODUCTION_INSTRUCTION', name: '生産指示', parentCode: 'MES', sortOrder: 1 },
  { code: 'MES_CUTTING_INSTRUCTION', name: '切断・面取指示', path: '/mes/instruction/cutting', parentCode: 'MES_PRODUCTION_INSTRUCTION', sortOrder: 1 },
  { code: 'MES_FORMING_INSTRUCTION', name: '成型指示', path: '/mes/instruction/forming', parentCode: 'MES_PRODUCTION_INSTRUCTION', sortOrder: 2 },
  { code: 'MES_WELDING_INSTRUCTION', name: '溶接指示', path: '/mes/instruction/welding', parentCode: 'MES_PRODUCTION_INSTRUCTION', sortOrder: 3 },
  { code: 'MES_PLATING_INSTRUCTION', name: 'メッキ指示', path: '/mes/instruction/plating', parentCode: 'MES_PRODUCTION_INSTRUCTION', sortOrder: 4 },
