...
from app.modules.master.routers.api_label_quantity import router as label_quantity_router
...
router.include_router(label_quantity_router, prefix="/label-quantity", tags=["ラベル枚数管理"])
